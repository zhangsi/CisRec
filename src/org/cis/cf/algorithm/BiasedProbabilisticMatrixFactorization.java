...
public class BiasedProbabilisticMatrixFactorization implements RatingPredictor{
	...
	public BiasedProbabilisticMatrixFactorization(Ratings ratings, int featureNumber){
		...
		this.userBias     = new double[userNumber];
		this.itemBias     = new double[itemNumber];
	}
	
	public BiasedProbabilisticMatrixFactorization(Ratings ratings, int featureNumber, double learnRate,
